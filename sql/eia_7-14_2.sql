...
-- Records of products
-- ----------------------------
INSERT INTO `products` VALUES ('1', 'airbnb', 'Rent unique accommodations from local hosts in 190+ countries. Feel at home anywhere you go in the world with Airbnb.', '99.99', '', '4', '1');
INSERT INTO `products` VALUES ('2', 'uno', 'Uno (/ˈuːnoʊ/; from Italian and Spanish for \'one\') is an American card game which is played with a specially printed deck (see Mau Mau for an almost identical game played with normal playing cards). ', '19.99', '', '3', '2');
